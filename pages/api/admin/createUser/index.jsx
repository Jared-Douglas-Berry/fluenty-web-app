...
export default async function handler(req, res) {
    ...
    if (req.method === 'POST') {
        ...
        try {
            result = await insertDocument(clientMD, newTechStack, process.env.mongodb_database, process.env.mongodb_database_user);
        ...
        try {
            ...
            const result = await deleteDocumentById(clientMD, process.env.mongodb_database, process.env.mongodb_database_user, documentIdToDelete);
        ...
        if (req.body.isFeaturedId) {
            ...
            try {
                // Update the document
                const result = await updateDocumentById(clientMD, process.env.mongodb_database, process.env.mongodb_database_user, isFeaturedId, updatedData);
            ...
            try {
                // Update the document
                const result = await updateDocumentById(clientMD, process.env.mongodb_database, process.env.mongodb_database_user, documentIdToUpdate, updatedData);
